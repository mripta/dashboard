            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <form method="post" role="form" action="{{ route('alerts.update', $alert->id) }}" data-parsley-validate>
                            <div class="card-body">
                                ...
                                <div class="row"> 
                                    <div class="col-6">
                                        <div class="form-check{{ $errors->has('enabled') ? ' has-error' : '' }}">
                                            <input type="checkbox"class="form-check-input" id="enabled" name="enabled" @if($alert->enabled) checked @endif>
